...
fun ScreenContent(modifier: Modifier) {
    ...
    Column(
        ...
        if (totalHarga != 0f) {
            ...
            Text(
                text = stringResource(id = R.string.invoice, nama, jumlah, totalHarga, context.getString(kategori)),
            ...
            Button(onClick = {
                shareData(
                    context = context,
                    message = context.getString(R.string.bagikan_template, jumlah, totalHarga, context.getString(kategori))
                )
            },
                modifier = Modifier.padding(top = 8.dp),
                contentPadding = PaddingValues(horizontal = 32.dp, vertical = 16.dp)
